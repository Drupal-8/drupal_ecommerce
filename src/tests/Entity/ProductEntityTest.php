...
/**
 * @file
 * Test cases for Product Entity Module.
 */
...
/**
 * Tests the basic functions of the Ecommerce module.
 *
 * @package Drupal\ecommerce\Tests
 *
 * @ingroup product_entity
 *
 * @group product_entity
 * @group example
 */
class ProductEntityTest extends WebTestBase {

  public static $modules = array('ecommerce', 'block', 'field_ui');
